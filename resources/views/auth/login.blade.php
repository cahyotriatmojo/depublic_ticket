...
<body class="bg-white overflow-x-hidden">
    ...
    <div class="flex flex-col min-h-screen pt-16 overflow-hidden bg-white dark:bg-gray-100">
        <div class="bg-surface-900 flex justify-between items-center border-b">
            <h1 class="text-l font-bold m-3">Sign In</h1>
        ...
        <div id="main-content" class="relative flex-grow w-full max-w-screen-2xl mx-auto h-full overflow-y-auto bg-white dark:bg-gray-900 overflow-x-hidden">
            <main class="flex items-center justify-center relative bg-no-repeat bg-right-top overflow-hidden" style="background-image: url('{{ asset('images/banner/bg-2.png') }}'); background-size: 150px;">
                <div class=" p-8 w-full max-w-2xl mx-auto border-b-[8px] border-gray-200" >
                    ...
                    <div class="px-4 2xl:px-0" >
                        ...
                        <h1 class="text-lg font-semibold mb-4">Welcome Back!</h1>
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="mt-4">
                                ...
                                <div class="flex items-center justify-center">
                                    <h1 class="text-md font-light text-gray-500 mr-3 justify-center flex">don't have an account?</h1>
                                    <a href="{{ route('register') }}" class="text-purple-500 font-bold text-md">Register</a>
                                </div>
